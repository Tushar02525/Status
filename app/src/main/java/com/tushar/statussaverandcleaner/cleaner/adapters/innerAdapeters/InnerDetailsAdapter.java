package com.tushar.statussaverandcleaner.cleaner.adapters.innerAdapeters;
...
public class InnerDetailsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == IMAGES) {
            View view = LayoutInflater.from(ctx).inflate(R.layout.image_content_cleaner, parent, false);
            return new InnerDataViewHolderMultimedia(view);
        } else if (viewType == VIDEOS) {
            View view = LayoutInflater.from(ctx).inflate(R.layout.videos_content_cleaner, parent, false);
            return new InnerDataViewHolderVideos(view);
        } else if (viewType == VOICE) {
            View view = LayoutInflater.from(ctx).inflate(R.layout.doc_content_cleaner, parent, false);
