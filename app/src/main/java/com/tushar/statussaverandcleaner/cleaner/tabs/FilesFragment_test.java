    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        switch (category) {
            ...
            case DataHolder.IMAGE:
                rootView = inflater.inflate(R.layout.status_activity_cleaner, container, false);
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            try {
                                                ...
                                                for (FileDetails details : filesToDelete) {
                                                    ...
                                                    Uri uri = FileProvider.getUriForFile(getContext(), requireContext().getApplicationContext().getPackageName() +
